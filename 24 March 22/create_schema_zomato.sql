...
-- zomato."area" definition

-- Drop table

-- DROP TABLE zomato."area";

CREATE TABLE zomato."area" (
...
CREATE TABLE zomato.restaurant_address (
	...
	CONSTRAINT restaurant_address_area_id_fkey FOREIGN KEY (area_id) REFERENCES zomato.area(area_id)
);
